...
function w3CodeColorize(x, lang) {
  ...
  function tiinstructionMode(txt) {
    ...
    txt = txt.replace(/^(# +(?:Data Input|Data Postprocessing|Data Preprocessing|Data Processing|Subroutine).*)$/gm, '_SECTION_BEGIN_$1_SECTION_END_');
    ...
    // Make links to docs and replace "&nbsp;" with spaces, ex. "Training with your EC-4000 Programmable Calculator.pdf"
